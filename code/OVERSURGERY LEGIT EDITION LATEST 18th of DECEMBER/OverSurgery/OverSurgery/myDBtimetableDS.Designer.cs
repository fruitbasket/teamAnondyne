...
namespace OverSurgery {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("myDBtimetableDS")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class myDBtimetableDS : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected myDBtimetableDS(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            myDBtimetableDS cln = ((myDBtimetableDS)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "myDBtimetableDS";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/myDBtimetableDS.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            myDBtimetableDS ds = new myDBtimetableDS();
        ...
        public partial class TimetableDataTable : global::System.Data.TypedTableBase<TimetableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TimetableRow AddTimetableRow(int StaffID, int PatientID, string Date, string Time) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TimetableRow FindBySlotID(int SlotID) {
        ...
        public partial class TimetableRow : global::System.Data.DataRow {
            ...
            public int StaffID {
                get {
                    return ((int)(this[this.tableTimetable.StaffIDColumn]));
                }
                set {
                    this[this.tableTimetable.StaffIDColumn] = value;
                }
            }
            ...
            public int PatientID {
                get {
                    return ((int)(this[this.tableTimetable.PatientIDColumn]));
                }
                set {
                    this[this.tableTimetable.PatientIDColumn] = value;
                }
            }
...
namespace OverSurgery.myDBtimetableDSTableAdapters {
    ...
    public partial class TimetableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Timetable] WHERE (([SlotID] = @Original_SlotID) AND ([StaffID]" +
                " = @Original_StaffID) AND ([PatientID] = @Original_PatientID) AND ([Date] = @Ori" +
                "ginal_Date) AND ([Time] = @Original_Time))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Timetable] ([StaffID], [PatientID], [Date], [Time]) VALUES (@S" +
                "taffID, @PatientID, @Date, @Time);\r\nSELECT SlotID, StaffID, PatientID, Date, Tim" +
                "e FROM Timetable WHERE (SlotID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Timetable] SET [StaffID] = @StaffID, [PatientID] = @PatientID, [Date] = @Date, [Time] = @Time WHERE (([SlotID] = @Original_SlotID) AND ([StaffID] = @Original_StaffID) AND ([PatientID] = @Original_PatientID) AND ([Date] = @Original_Date) AND ([Time] = @Original_Time));
SELECT SlotID, StaffID, PatientID, Date, Time FROM Timetable WHERE (SlotID = @SlotID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SlotID, StaffID, PatientID, Date, Time FROM dbo.Timetable";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT dbo.Patient.FirstName, dbo.Patient.LastName, dbo.Staff.FirstName, dbo.Staff.LastName, dbo.Timetable.Date, dbo.Timetable.Time FROM dbo.Timetable INNER JOIN dbo.Patient ON dbo.Timetable.PatientID=dbo.Patient.ID INNER JOIN dbo.Staff ON dbo.Timetable.StaffID=dbo.Staff.StaffID";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[Timetable] ([StaffID], [PatientID], [Date], [Time]) VALUES (@S" +
                "taffID, @PatientID, @Date, @Time);\r\nSELECT SlotID, StaffID, PatientID, Date, Tim" +
                "e FROM Timetable WHERE (SlotID = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(myDBtimetableDS.TimetableDataTable dataTable) {
        ...
        public virtual myDBtimetableDS.TimetableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            myDBtimetableDS.TimetableDataTable dataTable = new myDBtimetableDS.TimetableDataTable();
        ...
        public virtual int FillBy(myDBtimetableDS.TimetableDataTable dataTable) {
        ...
        public virtual myDBtimetableDS.TimetableDataTable GetDataBy1() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            myDBtimetableDS.TimetableDataTable dataTable = new myDBtimetableDS.TimetableDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(myDBtimetableDS.TimetableDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(myDBtimetableDS dataSet) {
        ...
        public virtual int Delete(int Original_SlotID, int Original_StaffID, int Original_PatientID, string Original_Date, string Original_Time) {
        ...
        public virtual int Insert(int StaffID, int PatientID, string Date, string Time) {
        ...
        public virtual int Update(int StaffID, int PatientID, string Date, string Time, int Original_SlotID, int Original_StaffID, int Original_PatientID, string Original_Date, string Original_Time, int SlotID) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(SlotID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int StaffID, int PatientID, string Date, string Time, int Original_SlotID, int Original_StaffID, int Original_PatientID, string Original_Date, string Original_Time) {
            return this.Update(StaffID, PatientID, Date, Time, Original_SlotID, Original_StaffID, Original_PatientID, Original_Date, Original_Time, Original_SlotID);
        }
        ...
        public virtual int InsertQuery(int StaffID, int PatientID, string Date, string Time) {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(myDBtimetableDS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._timetableTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(myDBtimetableDS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._timetableTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(myDBtimetableDS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._timetableTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(myDBtimetableDS dataSet) {
            if ((dataSet == null)) {
